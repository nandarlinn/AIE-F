...
# Dataset: "single" colour-mode PNGs (3 samples per class, 3000 total)
...
CONFIG = {
    ...
    "model_name":    "shufflenet_v2_x1_0_single",
    "num_classes":   1000,           # one class per Myanmar syllable
    "color_mode":    "single",       # which image variant to train on
...
ORGANISED_DIR = "/kaggle/working/organised_single"
