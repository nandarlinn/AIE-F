...
# Dataset: "stroke" colour-mode PNGs (3 samples per class, 3000 total)
...
CONFIG = {
    ...
    "model_name":    "shufflenet_v2_x1_0_stroke",
    "num_classes":   1000,           # one class per Myanmar syllable
    "color_mode":    "stroke",       # stroke-order colour encoding
...
ORGANISED_DIR = "/kaggle/working/organised_stroke"
