# ============================================================================
# Myanmar Syllable Handwriting — ConvNeXt Tiny
...
CONFIG = {
    ...
    # TUNED FOR TIME MODE: 'time' mode contains color gradients (red to blue) 
    # representing stroke speed. The backbone needs to adapt to these new 
    # color features, so we use slightly higher LRs and more epochs.
    "stage2_lr_backbone": 1e-5,   # slightly higher for time mode color features
    "stage2_lr_head":     5e-5,   # head adapts faster
    "stage2_epochs": 80,          # extended training for complex features
    "patience":      15,          # monitor top-5 acc (less noisy than val_loss)
    "weight_decay":  1e-4,
