"""
train_g2p_transformer_warmup_dropout.py
========================================
Experiment 3: Warmup + Dropout COMBINED
...
MODEL_DIR    = os.path.join(WORKING_DIR, "model.transformer.myph.warmup_dropout")
...
print(f"\n[config] Experiment : WARMUP + DROPOUT COMBINED")
...
hyp_file = os.path.join(WORKING_DIR, f"transformer.{SRC}{TGT}.warmup_dropout.hyp.txt")
...
print(f"\n[DONE] G2P Transformer training complete — Experiment: WARMUP + DROPOUT")
