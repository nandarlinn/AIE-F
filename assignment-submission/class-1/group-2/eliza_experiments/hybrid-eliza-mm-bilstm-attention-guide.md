# `hybrid-eliza-mm-bilstm-attention.py` Guide

This file explains how `hybrid-eliza-mm-bilstm-attention.py` works, from text input to ELIZA response and emotion prediction.
