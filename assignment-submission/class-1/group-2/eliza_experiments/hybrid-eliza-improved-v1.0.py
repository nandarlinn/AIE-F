...
SCRIPTS = {
    "en": {
     ...
     "mm": {
        ...
        "keywords": [
            [r"(.*)(သေချင်|မနေချင်တော့|ကိုယ့်ကိုယ်ကို သတ်ချင်)(.*)",
            ["အဲဒီလို ခံစားနေရတာကို ပိုပြောပြပါ။ အခု ဘာဖြစ်နေတယ်လို့ ထင်သလဲ။"], 10],

            [r"(?:ကျွန်တော်|ကျွန်မ|ငါ)\s?(.*)လိုအပ်(?:တယ်|ပါတယ်)",
            ["ဘာကြောင့် {0} လိုအပ်တာလဲ။", "{0} ရရင် သက်သာမယ်လို့ ထင်သလား။"], 6],

            [r"(?:ကျွန်တော်|ကျွန်မ|ငါ)\s?(.*)ခံစားရ(?:တယ်|ပါတယ်)",
            ["{0} လို့ ခံစားရတာ ဘယ်အချိန်က စတာလဲ။", "{0} လို့ ခံစားရတာကို ပိုရှင်းပြပါ။"], 6],

            [r"(?:ကျွန်တော်|ကျွန်မ|ငါ)\s?(.*)ဖြစ်နေ(?:တယ်|ပါတယ်)",
            ["{0} ဖြစ်နေတာ ဘာကြောင့်လို့ ထင်သလဲ။", "{0} ဖြစ်နေတာကို ပိုပြောပြပါ။"], 5],

            [r"(.*)(ဝမ်းနည်း|စိတ်မကောင်း|မပျော်)(.*)",
            ["အဲဒီလို ခံစားနေရတာကို ပိုပြောပြပါ။",
            "ဘာတွေကြောင့် အခုလို ခံစားနေရတာလဲ။"], 7],

            [r"(.*)(စိတ်ဆိုး|ဒေါသထွက်)(.*)",
            ["ဘာကြောင့် စိတ်ဆိုးနေရတာလဲ။",
            "ဒီအရာက သင့်ကို ဘယ်လို ထိခိုက်စေတာလဲ။"], 7],

            [r"(.*)(ကြောက်|စိုးရိမ်)(.*)",
            ["ဘာကို အများဆုံး စိုးရိမ်နေတာလဲ။",
            "အဲဒီကြောက်ရွံ့မှုကို ပိုရှင်းပြပါ။"], 7],
            [r"(.*)(ပျော်|ဝမ်းသာ)(.*)",
...
def tokenize_for_rules(text, lang):
    text = normalize_text(text)
    if not text:
        return []
...
class HybridEliza:
    ...
    def reflect(self, fragment):
        tokens = tokenize_for_rules(fragment, self.lang)
