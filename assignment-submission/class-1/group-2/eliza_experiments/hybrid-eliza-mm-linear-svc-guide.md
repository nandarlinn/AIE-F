# `hybrid-eliza-mm-linear-svc.py` Guide

This document explains the step-by-step logic flow of `hybrid-eliza-mm-linear-svc.py`.

## 1. High-Level Purpose

`hybrid-eliza-mm-linear-svc.py` combines:
...
```bash
python hybrid-eliza-mm-linear-svc.py --mode train
```
...
```bash
python hybrid-eliza-mm-linear-svc.py
```

or explicitly:

```bash
python hybrid-eliza-mm-linear-svc.py --mode chat
```
