...
Assignment တင်ရန် final report, notebooks, training process logs, decoded outputs, BLEU results, and tuned model configs များကို အောက်ပါ folder ထဲမှာ စုစည်းထားပါတယ်။
...
assignment6_submission/
  ...
  report.md
  notebooks/
    assignment6_baseline_pbsmt.ipynb
    assignment6_bleu_improvement.ipynb
  results/
    baseline/
      test.decoded.ph
      test.multi-bleu.txt
